/* https://getmatcha.com/wp-content/plugins/contact-form-7/includes/js/scripts.js */
try{
...
/* https://getmatcha.com/wp-content/plugins/wpcf7-redirect/js/wpcf7-redirect-script.js */
try{
...
/* https://getmatcha.com/wp-content/themes/getmatcha/js/theme.min.js */
try{
/*!
 ...
 */
		...
		p._mod = p._roundProps = function(lookup) {
			...
			while (pt) {
				...
				if (val && typeof(val) === "function") { //some properties that are very plugin-specific add a prefix named after the _propName plus an matcha, so we need to ignore that extra stuff here.
					if (pt.f === 2) {
						pt.t._applyPT.m = val;
					} else {
						pt.m = val;
...
(function ($, undefined) {
    ...
    $(document).ready(function () {
        ...
        // Remove Headroom on the Platform page
        if (!jQuery('body').hasClass('page-template-platform'))
        {
            $("#masthead").headroom(
                {
            ...
            if (is_mobile == false) {
                added_space = 0;
                header_height = header_height + added_space;
            }
            else
            {
                added_space = 0;
            ...
            if (jQuery('body').hasClass('page-template-platform'))
            {
                jQuery('.jump-menu-platform a').on('click', function (e) {
                    e.preventDefault();
                    ...
                    jQuery('.jump-menu-platform a').each(function () {
                    ...
                    TweenMax.to(window, 0.8, {scrollTo:$target.offset().top-header_height, autoKill:false, ease:Power4.easeInOut});
                });
            }
            if (jQuery('body').hasClass('page-template-about'))
            {
                jQuery('.jump-menu-about a').on('click', function (e) {
                    e.preventDefault();
                    if($('header').hasClass('active'))
                    {
                        $('header').toggleClass('active')
                    ...
                    jQuery('.jump-menu-about a').each(function () {
                        jQuery(this).removeClass('active');
                    })
                    jQuery(this).addClass('active');
                    var target = this.hash,
            ...
            {
                jQuery('.jump-menu-pricing').on('click', function (e) {
                    e.preventDefault();
                    if($('header').hasClass('active'))
                    {
                        $('header').toggleClass('active')
        ...
        $('.request-a-demo-btn').click(function() {
            jQuery('#request-demo').addClass('md-show');
            return false;
        });
        $('.demo-close-btn').click(function() {
            jQuery('#request-demo').removeClass('md-show');
            return false;
        });
        ...
        $('.closer-look-btn').click(function() {
            // change text in btn
            $(this).toggleClass('show');
            // rotate plus

            // hide/show pricing table
            $('.pricing-table').toggleClass('show-table');
            return false;
        });
        ...
        $('.entry-content').fitVids();
          ...
          if ($('.single').length) {
            ...
            var relatedPostsHeight = $('.related-stories').height();
            var lastDocumentHeight = $(document).height() - (footerHeight + relatedPostsHeight);
            var ticking = false;
            ...
            update();
				...
				// Update Pardot success_location so that email is passed through to onboarding form
        // $('.js-trial-form').on('change paste keyup', function() {
        //   $(this).attr('action',
        //     $(this).attr('action').split('?')[0] +
        //     '?success_location=' +
        //     encodeURIComponent('https://app.getmatcha.com/sso/register?email=' + $(this).find('.js-trial-form__email').val())
        //   );
        // });

				// Fill in UTM parameter hidden fields
				var url_params = new URLSearchParams(window.location.search);
				var utm_params = ['utm_campaign', 'utm_content', 'utm_medium', 'utm_source', 'utm_term'];
				jQuery.each(utm_params, function(idx, param) {
					jQuery("input[name='" + param + "']").each(function(idx, field){
						field.value = url_params.get(param);
					});
				});
        ...
        if (jQuery('body').hasClass('page-template-platform')) {
            ...
            jQuery('.opn-item a').on('click', function (e) {
                e.preventDefault();
                var top_spacing = hh;
                ...
                jQuery('.opn-item a').each(function () {
                ...
                jQuery('html, body').stop().animate({
                    'scrollTop': $target.offset().top-top_spacing
                }, 600, 'swing', function () {
                    //window.location.hash = target;
                    jQuery(document).on("scroll", onScroll);
                });
            });
            // smooth scroll from a page other than front.
            ...
            if (hash) {
              setTimeout(function() {
                ...
                window.scrollTo(0, 0);
                var target = jQuery('.platform-main-menu li a[href*=#'+hash+']');
            ...
            function onScroll(event){
                ...
                jQuery('.opn-item a').each(function () {
                    ...
                    var refElement = jQuery(this.hash);
                    if (refElement.length) {
                        if (refElement.position().top-(hh+70) <= scrollPos && refElement.position().top-(hh+70) + refElement.height() > scrollPos) {
        ...
        function applyCMSConditionality(cms) {
	        $('.js-cms-feature').each(function() {
	        ...
	        $('.js-cms-features').each(function() {
		        $(this).children('.is-even').removeClass('is-even');
		        $(this).children('.is-active:even').addClass('is-even');
	        });
        }
        applyCMSConditionality('shopify');

        $('.js-cms-switch-option').on('click', function() {
	        var selectedCMS = $(this).data('cms');
	        $(this).siblings().removeClass('is-active');
	        $(this).addClass('is-active');
	        
	        applyCMSConditionality(selectedCMS);        
        });
    ...
    $(window).scroll(function() {
        ...
        var $platform_menu = $('.platform-menu-sticky');
        if (jQuery('body').hasClass('page-template-platform')) {
            if (scroll >= $('.platform-hero').height()) {
                $site_header.addClass('headroom--pinned').addClass('headroom--not-bottom');
                $platform_menu.addClass('stickit');
            } else {
                $site_header.removeClass('headroom--pinned').removeClass('headroom--not-bottom');
                $platform_menu.removeClass('stickit');
            }
        }
    ...
    $(window).resize(function () {
        ...
        $('.experience-blocks ul li').matchHeight({byRow: false});
        $('.team-wrapper .team-member').matchHeight({byRow: false});
        $('.carousel-inner .carousel-item .card').matchHeight({byRow: false});
        checkMobileMenu();

    });

    function hidePreloader(){
        TweenMax.to(jQuery("#preloader-status"), .3, {css:{opacity:0}, ease:Linear.easeNone,onComplete:function(){
            //(this.target).hide();
        }});

        TweenMax.to(jQuery("#preloader"), .3, {css:{opacity:0}, ease:Linear.easeNone, delay:.3,onComplete:function(){
            (this.target).hide();
        }});
    }

    $( ".pricing-nav" ).on( "click", "li", function() {
      ...
      function checkMobileMenu(){
        // Initialize the media query
          var mediaQuery = window.matchMedia('(min-width: 1026px)');
...
/* https://getmatcha.com/wp-includes/js/wp-embed.min.js */
try{
